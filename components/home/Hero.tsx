...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-primary-200 rounded-full blur-3xl opacity-30" />
      ...
      <div className="relative container-custom py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 flex justify-center lg:justify-start">
            <div className="relative">
              ...
              <div className="relative w-72 h-96 md:w-80 md:h-[28rem] lg:w-96 lg:h-[32rem]">
                ...
                <div className="absolute -inset-4 bg-primary-100 rounded-[2rem] rotate-3 opacity-60" />
                ...
                <div className="relative w-full h-full rounded-[1.5rem] overflow-hidden border-4 border-white shadow-2xl bg-cream-200">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-cream-200 to-cream-300">
                    <div className="text-center p-8">
                      ...
                      <p className="text-primary-500 font-medium text-sm">Upload photo to</p>
                      <p className="text-primary-600 font-mono text-xs mt-1">/public/tara.jpg</p>
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-6 -right-6 lg:-right-12 bg-white rounded-xl shadow-xl p-4 border border-cream-300">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-text-primary leading-[1.1] mb-6">
              Hi, I&apos;m Tara.
            ...
            <div className="mt-12 pt-8 border-t border-cream-300">
              <p className="text-sm text-text-subtle mb-3">Trusted by teams at</p>
              <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center lg:justify-start text-text-muted font-medium">
                <span>ZocDoc</span>
                <span>Evernote</span>
